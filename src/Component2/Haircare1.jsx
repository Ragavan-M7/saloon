...
import sal42 from '../assets/sal42.png';
  ...
  return (
    ...
    <div style={{ backgroundColor: '#eb81ad', padding: '10px 0' }}>
     ...
     {/* Navbar */}
          ...
          <h2 className='py-3 px-4 fw-bold'>Pricing for Haircare</h2>
          ...
          style={{
            ...
            <Container>
              <Row
                ...
                <Col xs={12} md={4}>
                  <h4>HAIRCARE / HAIRSTYLE</h4>
                  <p>Classic-Basics cuts</p>
                  <p>Layer Trim</p>
                  <p>Bangs-Fringes</p>
                  <p>Kids Cut</p>
                  <p>Hair wash - Blowdry</p>
                  <p>Hair Colouring</p>
                  <p>Ironing</p>
                  <p>Tongs</p>
                </Col>
