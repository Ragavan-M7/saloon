...
import sal43 from '../assets/sal43.png';
  ...
  return (
    ...
    <div style={{ backgroundColor: '#eb81ad', padding: '10px 0' }}>
     ...
     {/* Navbar */}
          ...
          <h2 className='py-3 px-4 fw-bold'>Pricing for Skincare</h2>
       ...
       <div
          style={{
            ...
            <Container>
              <Row
                style={{ fontSize: "20px" }}
                className="align-items-center text-center text-md-start fw-bold gy-4" >
                <Col xs={12} md={4}>
                  <h4>SKINCARE</h4>
                  <p>Clean up</p>
                  <p>Insta Full Fresh</p>
                  <p>De-tan for face and neck</p>
                  <p>OMG Charcoal</p>
                  <p>Gold and Glow Facial</p>
                  <p>ILLuminating Facial</p>
                  <p>Natural Brightening Facial</p>
                  <p>Deep sea hydration Facial</p>
                </Col>
