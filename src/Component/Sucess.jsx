...
import sal41 from '../assets/sal41.png';
...
const Sucess= () => {
  return (
   ...
   {/* Navbar */}
    ...
    <div style={{marginTop:'130px',}} className='text-center py-4'>
      <h1 style={{color:'#BE5985'}}>Thank You for Your Booking...!</h1>
      <h5 className='py-3'>Our Team will reach out you soon..!</h5>
      <img src={sal41} alt="" />
    </div>
   <Link to='/'><h5 className='py-2' style={{marginLeft:'1000px',color:'blue',textDecoration:'none'}}>Back to main website</h5></Link> 
