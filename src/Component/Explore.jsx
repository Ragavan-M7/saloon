...
import sal37 from '../assets/sal37.png';
import sal38 from '../assets/sal38.png';
import sal39 from '../assets/sal39.png';
...
const Explore= () => {
  ...
  <Link style={{textDecoration:'none',color:'black'}} to='/Artist'><h2 className='py-3 px-3 fw-bold'>Explore Our Makeup Artists</h2></Link> 
        ...
        <Row className="g-4">
          <Col md={4} sm={12}>
            <div className="position-relative text-center">
              <img src={sal37} alt="S.SAMEERA" className="img-fluid rounded" style={{height:'110vh',width:'100%'}}/>
          ...
          <Col md={4} sm={12}>
            <div className="position-relative text-center">
              <img src={sal38} alt="R.KARTHI" className="img-fluid rounded" style={{height:'110vh',width:'100%'}}/>
              <div className="position-absolute top-50 start-50 translate-middle text-white">
                <h2 style={{color:'#FFFF00',marginTop:'490px'}}  className="fs-4 ">R.KARTHI(Makeup Artist)</h2>
          ...
          <Col md={4} sm={12}>
            <div className="position-relative text-center">
              <img src={sal39} alt="S.MEENA" className="img-fluid rounded" style={{height:'110vh',width:'100%'}} />
              <div  className="position-absolute top-50 start-50 translate-middle text-white">
                <h2 style={{color:'#FFFF00',marginTop:'490px'}}  className="fs-4">S.MEENA(Makeup Artist)</h2>
                <h5 className="fs-6">
                  This look enhances the<br />
                  beauty of the bride  <br /> 
                  naturally with smokey <br /> 
