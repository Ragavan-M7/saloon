...
import sal12 from '../assets/sal12.png';
import sal13 from '../assets/sal13.png';
import sal14 from '../assets/sal14.png'
   ...
   {/* Navbar */}
      ...
      <Container>
        <Row>
          <Col md={6} xs={12} className="mb-3 mb-md-0">
            <img src={sal12} alt="South Indian Bride and Groom" className="img-fluid" />
          </Col>

          <Col md={6} xs={12} className="py-3">
            <h2 className="fw-bold">
              A Complete South Indian Bride <br />
              and GROOM
            </h2>
            <h5 className="py-2 fw-bold">(Senior Artist - DEEPA)</h5>
          </Col>
        </Row>
      </Container>
    </div>
      ...
      <Container>
        <Row>
          <Col md={6} xs={12} className="mb-3 mb-md-0 py-3 ">
            <h2 className='fw-bold'>
              A Perfect Christian <br />
              Wedding Look for Both <br />
              BRIDE and GROOM
            </h2>
            <h5 className="py-2 fw-bold">(Senior Artist - KAYAL)</h5>
          </Col>
          <Col md={6} xs={12}>
            <img src={sal13} alt="Christian Wedding Look" className="img-fluid" />
          </Col>
        </Row>
      </Container>
    </div>
    ...
    <div className="py-1">
      <Container>
        <Row>
          <Col md={6} xs={12} className="mb-3 mb-md-0">
            <img src={sal14} alt="South Indian Bride and Groom" className="img-fluid" />
          </Col>
          ...
          <Col md={6} xs={12} className="py-3">
            ...
            <h5 className="py-2 fw-bold">(Senior Artist - KARTHIK)</h5>
          </Col>
        </Row>
      </Container>
    </div>
