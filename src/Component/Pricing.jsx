...
import sal11 from '../assets/sal11.png';
    ...
    <div className="position-relative text-white">
      ...
      <div
        ...
        <Container>
          <Row>
            <Col>
              <h2 className="text-start" style={{ fontSize: '42px' }}>
                Our Prices
              </h2>
              <p className="text-start py-3" style={{ fontSize: '22px' }}>
                Transform your life into better. From trendy to nourishing treatments, <br />
                we bring out the best of you...
              </p>
            </Col>
          </Row>
          ...
          <Row className="pt-5 text-center gy-4">
            <Col md={4} xs={12}>
              <Link to="/Haircare1" style={{ textDecoration: 'none', color: 'white' }}>
                <h3 style={{ fontSize: '36px' }}>Haircare1</h3>
              </Link>
            </Col>
            <Col md={4} xs={12}>
              <Link to="/Skincare1" style={{ textDecoration: 'none', color: 'white' }}>
                <h3 style={{ fontSize: '36px' }}>Skincare1</h3>
              </Link>
            </Col>
            <Col md={4} xs={12}>
              <Link to="/Bodycare1" style={{ textDecoration: 'none', color: 'white' }}>
                <h3 style={{ fontSize: '36px' }}>Bodycare1</h3>
              </Link>
            </Col>
          </Row>
        </Container>
