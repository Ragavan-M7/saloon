...
import sal78 from '../assets/sal78.png';
import sal79 from '../assets/sal79.png';
    ...
    {/* Navbar */}
      ...
      <Container>
        <Row className="align-items-center gy-4">
          <Col md={6}>
            <img src={sal78} alt="Hair 1" className="img-fluid rounded" style={{ height: 'auto', maxHeight: '500px' }} />
          </Col>
          <Col md={6}>
            <img src={sal79} alt="Hair 2" className="img-fluid rounded" />
          </Col>
        </Row>
        ...
        <Row className="py-4">
          <Col>
            ...
            <p style={{ fontSize: '18px' }}>
              Hair coloring works by coating each strand with color (non-permanent color) or by penetrating each
              hair cuticle, entering the hair cortex, and bonding with the hair (permanent color). While non-permanent
              hair color can be shampooed out eventually, permanent color, as the name suggests, permanently colors the hair.
            </p>

            <div className="d-flex flex-wrap gap-3 py-3">
              <Button style={{ backgroundColor: '#EC7FA9', border: 'none' }}>Add to Cart</Button>
              <Button variant="outline" style={{ color: '#EC7FA9', borderColor: '#EC7FA9' }}>Book Now</Button>
            </div>
          </Col>
        </Row>
      </Container>
