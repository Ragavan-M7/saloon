...
import sal29 from '../assets/sal29.png';
import sal30 from '../assets/sal30.png';
import sal31 from '../assets/sal31.png';
import sal32 from '../assets/sal32.png';
...
const Haircare = () => {
  ...
  <Link style={{textDecoration:'none',color:'black'}} to='/Facial2'> <h2>Categerois</h2></Link>

    <div className='align-item-center'>
      <h2 style={{color:'#7D057D'}} className='text-center'>HAIR CARE</h2>
    </div>
                  ...
                  <Container>
                    <Row>
                      <Col md={6} xs={12} className="mb-3 mb-md-0 py-3 ">
                        ...
                        <Link to='/Haircare2'><button style={{backgroundColor:'white',padding:'17px 22px', borderRadius:'10px'}}>Service for Him</button></Link>
                      </Col>
                      <Col md={6} xs={12}>
                        <img src={sal29} alt="Christian Wedding Look" className="img-fluid" />
                      </Col>
                    </Row>
                  </Container>
                </div>
                            ...
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal30} alt="South Indian Bride and Groom" className="img-fluid" />
                                </Col>
                      
                                <Col md={6} xs={12} className="py-5">
                                  <h2 style={{color:'#BE5985'}} className="fw-bold">Hair Clean</h2>
                                  <h5 style={{fontSize:'26px'}} className="py-4 fw-bold">
                                                               In comparison to hair,a hair clean up is a <br />
                                                               grooming treatment that is focused on <br />
                                                               cleaning and exfoliating your hair.This <br />
                                                               typically involves using a varity of haircare <br />
...
{/* col-3 */}
              ...
              <div style={{backgroundColor:'#000000'}} className="align-item-center py-5">
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal31} alt="South Indian Bride and Groom" className="img-fluid" />
                                </Col>
                      
                                <Col md={6} xs={12} className="py-5">
                                  <h2 style={{color:'#BE5985',fontSize:'42px'}} className="fw-bold">Hair Coloring & <br />
                                                                                    Highlights</h2>
                                
                                <Link to='/Haircoloring'><button className='py-2 px-3 mt-4' style={{backgroundColor:'#BE5985'}}>BOOK NOW</button></Link> 
                                </Col>
                            </Row>
                         </Container>
                      </div>
                         ...
                         <Container>
                            <Row>
                               <Col md={6} xs={12} className="mb-3 mb-md-0 py-5 ">
                                  <h2 style={{color:'#BE5985'}}  className='py-5 fw-bold'>Hair SPA</h2>
                                 ...
                                 <Col md={6} xs={12}>
                                <img src={sal32} alt="Christian Wedding Look" className="img-fluid" />
                              </Col>
                            </Row>
                          </Container>
                      </div>
