...
import sal25 from '../assets/sal25.png';
import sal26 from '../assets/sal26.png';
import sal27 from '../assets/sal27.png';
import sal28 from '../assets/sal28.png';
...
const Skincare = () => {
  return (
   ...
   {/* Navbar */}
     ...
     <Link style={{textDecoration:'none',color:'black'}} to='/Facial1'> <h2>Categerois</h2></Link>
                  ...
                  <Container>
                    <Row>
                      <Col md={6} xs={12} className="mb-3 mb-md-0 py-3 ">
                       ...
                       <Link to='/Skincare2'> <button style={{textDecoration:'none',color:'black',backgroundColor:'white',padding:'17px 22px', borderRadius:'10px'}}>Service for Him</button></Link> 
                      </Col>
                      <Col md={6} xs={12}>
                        <img src={sal25} alt="Christian Wedding Look" className="img-fluid" />
                      </Col>
                    </Row>
                  </Container>
                </div>
                ...
                <Container>
                  <Row>
                    <Col md={6} xs={12} className="mb-3 mb-md-0">
                      <img src={sal26} alt="South Indian Bride and Groom" className="img-fluid" />
                    </Col>
    ...
    {/* col-3 */}
             ...
             <div style={{backgroundColor:'#000000'}} className="align-item-center py-5">
                <Container>
                  <Row>
                    <Col md={6} xs={12} className="mb-3 mb-md-0">
                      <img src={sal27} alt="South Indian Bride and Groom" className="img-fluid" />
                    </Col>
                 ...
                 <div className="py-1">
                    <Container>
                      <Row>
                        ...
                        <Col md={6} xs={12}>
                          <img src={sal28} alt="Christian Wedding Look" className="img-fluid" />
                        </Col>
                      </Row>
                    </Container>
                  </div>
