...
import sal53 from '../assets/sal53.png';
import sal54 from '../assets/sal54.png';
import sal55 from '../assets/sal55.png';
import sal56 from '../assets/sal56.png';
            ...
            <div style={{backgroundColor:'#000000'}} className="py-1 ">
                  <Container>
                    <Row>
                      ...
                      <Col md={6} xs={12}>
                        <img src={sal53} alt="Christian Wedding Look" className="img-fluid" />
                      </Col>
                    </Row>
                  </Container>
                </div>
                            ...
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal54} alt="South Indian Bride and Groom" className="img-fluid" />
                                </Col>
...
{/* col-3 */}
              ...
              <div style={{backgroundColor:'#000000'}} className="align-item-center py-5">
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal55} alt="South Indian Bride and Groom" className="img-fluid" />
                                </Col>
                          ...
                          <Link to='/Appoitment'><button className='py-2 px-3 mt-4' style={{backgroundColor:'#BE5985'}}>BOOK NOW</button></Link>  
                                </Col>
                            </Row>
                         </Container>
                      </div>
                         ...
                         <Container>
                            <Row>
                               <Col md={6} xs={12} className="mb-3 mb-md-0 py-5 ">
                                 ...
                                 <Col md={6} xs={12}>
                                <img src={sal56} alt="Christian Wedding Look" className="img-fluid" />
                              </Col>
                            </Row>
                          </Container>
                      </div>
