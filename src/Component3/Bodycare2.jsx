...
import sal49 from '../assets/sal49.png';
import sal50 from '../assets/sal50.png';
import sal51 from '../assets/sal51.png';
import sal52 from '../assets/sal52.png';
            ...
            <div style={{backgroundColor:'#000000'}} className="py-1 ">
                  <Container>
                    <Row>
                      ...
                      <Col md={6} xs={12}>
                        <img src={sal49} alt="Christian Wedding Look" className="img-fluid" />
                      </Col>
                    </Row>
                  </Container>
                </div>
                            ...
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal50} alt="South Indian Bride and Groom" className="img-fluid" />
                                </Col>
...
{/* col-3 */}
              ...
              <div style={{backgroundColor:'#000000'}} className="align-item-center py-5">
                            <Container>
                              <Row>
                                <Col md={6} xs={12} className="mb-3 mb-md-0">
                                  <img src={sal51} alt="South Indian Bride and Groom" className="img-fluid" style={{height:'50vh', width:'90vh'}}/>
                                </Col>
                         ...
                         <Container>
                            <Row>
                             ...
                             <Link to='/Appointment'> <button style={{backgroundColor:'#EC7FA9',borderRadius:'10px'}}>BOOK NOW</button></Link>
                                 ...
                                 <Col md={6} xs={12}>
                                <img src={sal52} alt="Christian Wedding Look" className="img-fluid py-5" />
                              </Col>
                            </Row>
                          </Container> 
                        </div> 
